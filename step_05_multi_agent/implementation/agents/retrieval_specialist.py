...
from step_05_multi_agent.implementation.agents.contracts import RetrievalResult
...
def retrieve(question: str, retriever: Step03HybridRAG, k: int = 10) -> RetrievalResult:
