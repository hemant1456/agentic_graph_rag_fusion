...
from evaluation.implementation.judge import _extract_json
from evaluation.implementation.metrics import (
    MetricResult,
    answer_relevance,
    context_precision,
    context_recall,
...
class TestFaithfulness:
    def test_high_score(self):
        ...
        with patch("evaluation.implementation.metrics.judge", return_value=mock_response):
