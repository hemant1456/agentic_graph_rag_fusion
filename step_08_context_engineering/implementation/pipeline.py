...
from step_07_multi_agent.implementation.agents import (
    critic,
    graph_navigator,
    query_analyst,
...
from step_08_context_engineering.implementation.context_engineer import engineer_context
...
class Step08RAG:
    ...
    Usage:
        ...
        result = rag.query_extended("Who is the CEO?")   # → Step08Result
    ...
    def query_extended(self, question: str) -> Step08Result:
        ...
        return Step08Result(rag_result=rag_result, ce_metrics=ce_metrics)
