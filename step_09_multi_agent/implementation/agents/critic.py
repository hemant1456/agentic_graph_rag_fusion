...
from step_09_multi_agent.implementation.agents.contracts import CriticResult
...
def review(question: str, answer: str, contexts: dict[str, str]) -> CriticResult:
    ...
    try:
        ...
        from llm_gatewayV2.client import LLM
        from step_09_multi_agent.implementation.agents.synthesis import _SYSTEM as SYNTH_SYS
