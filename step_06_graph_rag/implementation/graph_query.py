...
from step_05_knowledge_graph.implementation.query import (
    expand_context,
    extract_entity_ids as _exact_extract,
)
from step_06_graph_rag.implementation.aliases import resolve_aliases
...
def build_graph_context(question: str, chunk_texts: list[str], g: nx.DiGraph) -> str:
    ...
    """
    from step_06_graph_rag.implementation.aliases import ALIAS_LOOKUP
