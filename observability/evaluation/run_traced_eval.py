...
from observability.implementation.traced_pipeline import TracedRAG
from observability.implementation.tracer import TraceStore
...
def run_traced_evaluation(use_phoenix: bool = False) -> dict:
    ...
    otel_tracer = None
    if use_phoenix:
        from observability.implementation.phoenix_exporter import PhoenixExporter
    ...
    print(f"  uv run python observability/implementation/report.py --trace-id {first_id}")
    print(f"  uv run python observability/implementation/report.py --sources {first_id}")
    print(f"  uv run python observability/implementation/report.py --summary")
