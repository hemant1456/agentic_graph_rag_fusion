...
from step_09_vsa.implementation.pipeline import Step09RAG, Step09Result
from step_10_production.implementation.confidence import score_answer
from step_10_production.implementation.graceful_degradation import extractive_fallback
from step_10_production.implementation.health_monitor import HealthMonitor
from step_10_production.implementation.retry import with_retry
from step_10_production.implementation.semantic_cache import SemanticCache
...
class Step10RAG:
    ...
    def __init__(self, k: int = 5, cache_threshold: float = 0.92) -> None:
        ...
        self._inner: Step09RAG | None = None
    ...
    def build(self) -> "Step10RAG":
        ...
        self._inner = Step09RAG(k=self.k).build()
    ...
    def query_extended(self, question: str) -> Step10Result:
        ...
        def _run_pipeline():
            ...
            ext: Step09Result = self._inner.query_extended(question)
